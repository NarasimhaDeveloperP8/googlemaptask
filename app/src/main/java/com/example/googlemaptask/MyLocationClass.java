...
public class MyLocationClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mylocation_classs);
        ...
        // check perrmitions
        if (ActivityCompat.checkSelfPermission(com.example.googlemaptask.MyLocationClass.this,
            ...
            ActivityCompat.requestPermissions(com.example.googlemaptask.MyLocationClass.this,
